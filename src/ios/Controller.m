...
@interface Controller () <SDCBarcodeCaptureListener>
...
- (void)setupRecognition {
    ...
    UIView *top = [UIApplication sharedApplication].keyWindow.rootViewController.view;
         [top addSubview: self.captureView];
